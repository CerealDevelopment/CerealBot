...
const getFormattedAnswer = async (): Promise<{ embeds: MessageEmbed[] }> => {
  const message = {
    embeds: [
      new MessageEmbed()
        ...
        .setDescription(
          "\nThanks for using the CerealBot developed by the CerealTeam.\n" +
            ...
            "Please submit issues you have encountered under [Github Issues](https://github.com/CerealDevelopment/CerealBot/issues).\n" +
